...
@section('content')
    @push('message')
        rozpoczeliśmy realizację Twojego zamówienia nr <b>{{ $order->order_number }}</b>.
        Wyślemy Ci kolejnego maila, gdy zamówienie zostanie wysłane lub bęzie gotowe do odbioru.
    @endpush
