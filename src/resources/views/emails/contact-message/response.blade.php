...
@section('content')
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
           ...
           style="border-collapse:separate; mso-table-lspace:0; mso-table-rspace:0; background-color:#ffffff; border:2px solid #2563eb;">
        <tr>
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
        ...
        <tr>
            <td style="padding:16px 20px; font-family:Arial, sans-serif; font-size:14px; line-height:22px; color:#92400e;">
                <strong style="color:#78350f;">Masz dodatkowe pytania?</strong><br/>
                Jeśli potrzebujesz dalszej pomocy, odpowiedz na tego maila lub skontaktuj się z nami przez
