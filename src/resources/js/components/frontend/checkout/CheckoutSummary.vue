...
import CheckoutPromoCode from "@shopen/components/frontend/checkout/CheckoutPromoCode.vue";
...
<template>
    <div>
        ...
        <div class="px-4 py-4 pb-2 border-b border-dashed">
            <div class="flex justify-between items-end mb-2">
                ...
                <div class="flex flex-col items-end">
                    <div v-if="summary.productsSubtotal !== summary.productsTotal" class="text-gray-400 text-sm line-through">
        ...
        <div class="mt-2">
            ...
            >
                <IconLoader v-if="checkout.orderLoading"></IconLoader>
                <span class="ml-2" v-if="checkout.orderLoading">
