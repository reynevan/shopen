...
<template>
    <div
        class="product-thumbnail group sm:m-2 w-1/2 sm:w-[200px] border-b hover:shadow-lg transition-all duration-500 rounded"
        ...
        <div class="px-2 py-2">
            ...
            <div v-if="product.price" class="mt-2">
                <div class="price flex items-end">
                    <div>{{ product.price.final_price }}</div>
                    <div class="bg-green-50 text-emerald-500 font-semibold text-sm px-1 ml-2 rounded group-hover:hidden"
                ...
                <div class="text-sm text-neutral-500" v-if="product.price.omnibus_price">
