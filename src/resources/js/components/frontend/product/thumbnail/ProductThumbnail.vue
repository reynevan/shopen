...
<template>
    <div
        class="product-thumbnail relative mx-auto flex flex-col justify-between group w-full border-b hover:shadow-lg transition-all duration-500 rounded"
        :class="[product.in_stock ? 'in-stock' : 'out-of-stock', widthClasses, size === 'md' ? 'gap-2' : '']">
        <div>
            <div class="relative cursor-pointer overflow-hidden">
                <Link :href="product.url" class="group block relative w-full h-full">
