...
const typeClasses = {
    accent: 'bg-accent hover:bg-accent-hover disabled:bg-accent/70',
    primary: 'bg-secondary text-white hover:text-gray-100 hover:bg-secondary-hover disabled:bg-secondary/50 disabled:text-gray-300',
