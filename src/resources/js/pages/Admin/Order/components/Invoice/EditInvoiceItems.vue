        ...
        <tr class="border-b hover:bg-accent/50 transition-colors" v-for="(item, i) in form.items">
            <td class="pr-4 py-2">
                <div class="flex items-start pl-4 gap-4">
                    <div>
                        ...
                        <div v-if="item.product" class="text-neutral-500 text-sm" v-for="attribute in item.product.variant_attributes">
            ...
            <td class="py-2 px-2 text-right">
                <div class="flex justify-end">
                    <ActionButtons>
                        <ActionButton v-if="!item.editing" type="edit" @click="item.editing = true"/>
