...
<template>
    <BaseModal :show="props.show" @onClose="emits('onClose')" :closable-cover="false">
        ...
        <template #buttons>
            <Button type="ghost" size="lg" full-width @click="emits('onClose')">Anuluj</Button>
            <Button type="primary" size="lg" full-width @click="save" :loading="form.processing">Zapisz</Button>
        </template>
    </BaseModal>
</template>