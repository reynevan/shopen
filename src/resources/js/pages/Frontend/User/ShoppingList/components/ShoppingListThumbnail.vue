...
<template>
    <div class="border rounded-lg p-4 relative hover:shadow transition-all">
        <div class="absolute top-2 right-1">
            <Dropdown>
                ...
                <button
                    class="cursor-pointer w-full flex items-center justify-start gap-2 px-4 py-2 text-sm text-red-700 hover:bg-red-50 transition-all" role="menuitem">
                    <IconTrash/> Usuń
                </button>
            </Dropdown>
        </div>

        <Link :href="route('shopping-lists.show', list.id)">
